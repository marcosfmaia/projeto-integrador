        ...
        <div>
            ...
            <form action="" className="form-group">
                <fieldset className="form-group__cadastro">
                    ...
                    <input type="nome" id="user-nome" className="user-nome" placeholder="Nome Completo" />
                </fieldset>

                <fieldset className="form-group__cadastro">
                    <label htmlFor="user-email" className="label__text">Email</label>
                   
                    <input type="email" id="user-email" className="user-email" placeholder="Digite seu email" />
                </fieldset>

                <fieldset className="form-group__cadastro">
                    <label htmlFor="user-telefone" className="label__text">Telefone</label>
                    
                    <input type="number" name="user-telefone" className='user-telefone' placeholder="Digite seu telefone"/>
                </fieldset>

                <fieldset className="form-group__cadastro">
                    <label htmlFor="password" className="label__text">Senha</label>
                    <input type="password" name="pass" id="password" className="user-senha" placeholder="Digite uma senha forte"/>
                </fieldset>
